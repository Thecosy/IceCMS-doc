...
- You can find the complete source code for the **Pixels Admin** app on [GitHub](https://github.com/Thecosy/IceCMS/tree/master/examples/pixels-admin)
- Also **Pixel Client** app source code from previous days can be found [here](https://github.com/Thecosy/IceCMS/tree/master/examples/pixels)
...
[Here is the finalized version of what we’ll be building in this article:](https://github.com/Thecosy/IceCMS/tree/master/examples/pixels-admin)
...
- pages: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels-admin/src/pages
- components: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels-admin/src/components
- providers: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels-admin/src/providers
- utility: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels-admin/src/utility
- casbin: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels-admin/src/casbin
- types: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels-admin/src/types
- assets: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels-admin/public
...
If you wish to use our example Supabase backend, you can do so by using the provided [Supabase credentials](https://github.com/Thecosy/IceCMS/blob/master/examples/pixels-admin/src/utility/supabaseClient.ts).
