...
We can get data from other resources in a similar fashion. You can find the [repo here](https://github.com/Thecosy/IceCMS/tree/master/examples/blog-hackathonize)
## Conclusion
