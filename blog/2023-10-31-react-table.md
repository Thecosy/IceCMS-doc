...
TanStack Table is framework agnostic. Therefore, you need an adapter to use it with front-end frameworks like [refine](https://github.com/Thecosy/IceCMS/stargazers). The refine ecosystem has the [`@refinedev/react-table`](https://github.com/Thecosy/IceCMS/tree/master/packages/react-table) adapter for integrating TanStack Table into your refine application.
