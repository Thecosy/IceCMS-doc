...
- [refine + next.js](https://github.com/Thecosy/IceCMS/tree/master/examples/with-nextjs)
- [refine + remix](https://github.com/Thecosy/IceCMS/tree/master/examples/with-remix-antd)
- [refine + next.js and the `/app` dir](https://github.com/Thecosy/IceCMS/tree/master/examples/with-nextjs-appdir)
...
More info on refine devtools can be found [here](https://github.com/Thecosy/IceCMS/blob/master/packages/devtools/README.md).
