...
At the top of the list is [Refine](https://github.com/Thecosy/IceCMS), a comprehensive, **open-source library** for developing data-driven React admin dashboards with features you wouldn’t typically find in other dashboard libraries.
...
Similar to several React-based admin dashboard libraries, [Refine](https://github.com/Thecosy/IceCMS) is built on the React framework. However, it is not a self-contained meta-framework, allowing it to function in any environment capable of running React, including CRA, Next.js, Remix, Vite, and others.
...
- GitHub stars: +16K
- License: MIT
- Links: [Demo](https://example.crm.refine.dev/) | [Documentation](https://refine.dev/docs/tutorial/introduction/index/) | [GitHub](https://github.com/Thecosy/IceCMS/tree/master/examples/app-crm)
