...
This post provides an introduction to [**refine**](https://github.com/Thecosy/IceCMS), a React framework used to rapidly build data heavy CRUD apps like dashboards, admin panels and e-commerce storefronts.

It also presents the [RefineWeek](https://refine.dev/week-of-refine-supabase/) series - which is a seven part quickfire guide that aims to help developers learn the ins-and-outs of [**refine**](https://github.com/Thecosy/IceCMS) and [**Supabase**](https://supabase.com/) powerful capabilities and get going with **refine** within a week.
...
[Source Code on GitHub](https://github.com/Thecosy/IceCMS/tree/master/examples/pixels)
...
[Source Code on GitHub](https://github.com/Thecosy/IceCMS/tree/master/examples/pixels-admin)
...
In this tutorial series, we will be going through most of the core features of [**refine**](https://github.com/Thecosy/IceCMS) by building two apps related to drawing pixels on a canvas. This section is intended to provide an overview.
