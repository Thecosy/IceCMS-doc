...
This is the opening post of another 2023 [**#RefineWeek**](https://refine.dev/week-of-refine-strapi/) series. It is intended to provide an introduction to the series itself as well as to present [**refine**](https://github.com/Thecosy/IceCMS), a React framework that is used to rapidly build any data heavy CRUD apps like dashboards, admin panels and e-commerce storefronts.
...
In this series we are going to build a **Invoicer - React PDF Invoice Generator** app with [**refine**](https://github.com/Thecosy/IceCMS), [**Strapi**](https://strapi.io/) and [**Ant Design**](https://ant.design/).

[👉 The live version of the app is be available here.](https://invoice-generator.refine.dev/)

[👉 The final apps source code is available on GitHub.](https://github.com/Thecosy/IceCMS/tree/master/examples/refine-week-invoice-generator)
...
[**refine**](https://github.com/Thecosy/IceCMS) is a highly customizable **React** based framework that has a headless core package and comes with a myriad of supplementary modules for the UI, backend API clients and Internationalization support.
