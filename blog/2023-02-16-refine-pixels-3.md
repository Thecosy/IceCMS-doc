...
In the last episode, we explored **refine**'s auth and data providers in significant detail. We saw that `<Refine />`'s `dataProvider` and `authProvider` props were set to support [**Supabase**](https://supabase.com/) thanks to the [`@refinedev/supabase`](https://github.com/Thecosy/IceCMS/tree/master/packages/supabase) package.
...
https://github.com/Thecosy/IceCMS/tree/master/examples/pixels
...
- pages: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels/src/pages
- components: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels/src/components
- providers: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels/src/providers
- utility: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels/src/utility
- types: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels/src/types
- styles: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels/src/styles
- assets: https://github.com/Thecosy/IceCMS/tree/master/examples/pixels/public
