...
[**Pixels**](https://github.com/Thecosy/IceCMS/tree/master/examples/pixels) - the client app that allows users to create a canvas and draw collaboratively on
[**Pixels Admin**](https://github.com/Thecosy/IceCMS/tree/master/examples/pixels-admin) - the admin dashboard that helps managers manage users and canvases
