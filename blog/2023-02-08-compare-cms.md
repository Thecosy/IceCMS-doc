...
As highlighted above, refine has data providers for most CMS and platforms. You can use the [Hasura data provider](https://github.com/Thecosy/IceCMS/tree/master/packages/hasura) to communicate with your Hasura GraphQL API or REST API endpoints from a refine application.
