...
**[refine](https://github.com/Thecosy/IceCMS)** is a React-based framework for the rapid ✨ development of CRUD web applications. It eliminates the repetitive tasks demanded by CRUD operations and provides industry standard solutions for critical parts like authentication, access control, routing, networking, state management, and i18n. refine shines on data-intensive applications like admin panels, dashboards, internal tools and storefronts.

We're proud to have reached thousands of developers who used **[refine](https://github.com/Thecosy/IceCMS)**  in our first year, and we couldn't have done it without an open source community!
...
- **Submission guidelines:** [Follow the guidelines in this repository](https://github.com/Thecosy/IceCMS/blob/master/hackathon/readme-guideline.md)
...
- [Refer to refine GitHub repository](https://github.com/Thecosy/IceCMS)
