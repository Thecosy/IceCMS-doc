...
-   [Simple REST API](https://github.com/Thecosy/IceCMS/tree/master/packages/simple-rest)
-   [GraphQL](https://github.com/Thecosy/IceCMS/tree/master/packages/graphql)
-   [NestJS CRUD](https://github.com/Thecosy/IceCMS/tree/master/packages/nestjsx-crud)
-   [Airtable](https://github.com/Thecosy/IceCMS/tree/master/packages/airtable)
-   [Strapi](https://github.com/Thecosy/IceCMS/tree/master/packages/strapi) - [Strapi v4](https://github.com/Thecosy/IceCMS/tree/master/packages/strapi-v4)
-   [Strapi GraphQL](https://github.com/Thecosy/IceCMS/tree/master/packages/strapi-graphql)
-   [Supabase](https://github.com/Thecosy/IceCMS/tree/master/packages/supabase)
-   [Hasura](https://github.com/Thecosy/IceCMS/tree/master/packages/hasura)
-   [Nhost](https://github.com/Thecosy/IceCMS/tree/master/packages/nhost)
-   [Medusa](https://github.com/Thecosy/IceCMS/tree/master/packages/medusa)
-   [Appwrite](https://github.com/Thecosy/IceCMS/tree/master/packages/appwrite)
...
-   [React Router](https://github.com/Thecosy/IceCMS/tree/master/packages/react-router)
-   [React Location](https://github.com/Thecosy/IceCMS/tree/master/packages/react-location)
-   [Next.js Router](https://github.com/Thecosy/IceCMS/tree/master/packages/nextjs-router)
...
-   Auth0 - [Source Code](https://github.com/Thecosy/IceCMS/tree/master/examples/auth-auth0/) - [Demo](https://refine.dev/docs/examples/auth-provider/auth0)
-   Keycloak - [Source Code](https://github.com/Thecosy/IceCMS/tree/master/examples/auth-keycloak/) - [Demo](https://refine.dev/docs/examples/auth-provider/keycloak)
-   Google - [Source Code](https://github.com/Thecosy/IceCMS/tree/master/examples/auth-google-login) - [Demo](https://refine.dev/docs/examples/auth-provider/google-auth)
-   OTP Login - [Source Code](https://github.com/Thecosy/IceCMS/tree/master/examples/auth-otp) - [Demo](https://refine.dev/docs/examples/auth-provider/otpLogin)
...
-   Casbin - [Source Code](https://github.com/Thecosy/IceCMS/tree/master/examples/access-control-casbin) - [Demo](https://codesandbox.io/embed/github/refinedev/refine/tree/master/examples/access-control-casbin)
-   Cerbos - [Source Code](https://github.com/Thecosy/IceCMS/tree/master/examples/access-control-cerbos) - [Demo](https://codesandbox.io/embed/github/refinedev/refine/tree/master/examples/access-control-cerbos)
...
-   Ably - [Source Code](https://github.com/Thecosy/IceCMS/blob/master/packages/ably/src/index.ts) - [Demo](https://codesandbox.io/embed/github/refinedev/refine/tree/master/examples/live-provider-ably)
-   Supabase - [Source Code](https://github.com/Thecosy/IceCMS/blob/master/packages/supabase/src/index.ts#L187)
-   Appwrite - [Source Code](https://github.com/Thecosy/IceCMS/blob/master/packages/appwrite/src/index.ts#L252)
