...
In this blog, we'll show you how to create a React admin panel using [**refine**](https://github.com/Thecosy/IceCMS) and [PrimeReact](https://github.com/primefaces/primereact).
