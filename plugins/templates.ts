...
const templates = [
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/app-crm",
        reactPlatform: "Vite",
...
`,
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/finefoods-client",
...
The source code is also open-source; feel free to use or inspect it to discover how to Refine works with any custom designs & UI library and supports SSR with Next.js.`,
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/finefoods-material-ui",
        reactPlatform: "Vite",
...
`,
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/finefoods-antd",
        reactPlatform: "Vite",
        uiFramework: "Ant Design",
        dataProvider: "Rest API",
        authProvider: "Custom",
...
`,
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/store",
        reactPlatform: "Next.js",
        uiFramework: "Ant Design",
        dataProvider: "Medusa",
        authProvider: "Medusa",
...
- **Email Send and Verification**: Handles the sending of emails for purposes like account verification and marketing, and verifies email addresses.
    ...
    },
    {
        ...
        liveDemo: "https://store.refine.dev/",
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/pixels",
...
- **Audit Logging**: Implements an audit log for tracking pixel drawing activities in both the client and admin apps.
    ...
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/refine-week-invoice-generator",
...
- **PDF Invoice Generation**: Includes the capability to generate and view PDF documents of invoices using the @react-pdf/renderer package.
    ...
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/blog-win95",
        tutorial:
...
`,
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/multi-tenancy-strapi",
        tutorial:
...
The source code of this multitenancy app is open-source, allowing you to use or inspect it to see how Refine can fulfill enterprise-grade application requirements. 
    ...
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/multi-tenancy-appwrite",
        tutorial:
...
The source code of this multitenancy app is open-source, allowing you to use or inspect it to see how Refine can fulfill enterprise-grade application requirements. 
    ...
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/auth-antd",
...
Complete internal tool template built with Material UI. Features authentication and CRUD screens.
    ...
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/auth-material-ui",
        tutorial: "https://refine.dev/docs/tutorial/introduction/index/",
        reactPlatform: "Vite",
        uiFramework: "Material UI",
        dataProvider: "Rest API",
...
Complete internal tool template built with Material UI. Features authentication and CRUD screens.
    ...
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/auth-mantine",
        tutorial: "https://refine.dev/docs/tutorial/introduction/index/",
        reactPlatform: "Vite",
        uiFramework: "Mantine",
        dataProvider: "Rest API",
...
Complete internal tool template built with Mantine. Features authentication and CRUD screens.
    ...
    },
    {
        ...
        github: "https://github.com/Thecosy/IceCMS/tree/master/examples/auth-chakra-ui",
        tutorial: "https://refine.dev/docs/tutorial/introduction/index/",
        reactPlatform: "Vite",
